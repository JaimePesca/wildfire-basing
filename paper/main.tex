...
cycle-endogenous productivity, as a two-stage mean-risk (CVaR)
stochastic program with an exact linearization and a fix-and-optimize
matheuristic whose reduced subproblems are exact. An open-data case
