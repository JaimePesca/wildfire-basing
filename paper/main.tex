...
McCormick linearization, yielding a mixed-integer linear program
(MILP).
...
standard across the ST-DBSCAN software ecosystem: the original
non-spatial attribute threshold becomes a continuous temporal radius
intersected with the spatial one, and border points join the first
